...
return [
    ...
    // --------------------------------------------------
    //     `ssh` => SSH server related configurations
    // --------------------------------------------------
    'ssh' => [

        // ------------------------------------------------
        //     *`default` => Default ssh server to use
        //     (should in the list of `servers` below)
        // ------------------------------------------------
        'default' => 'example',

        // -------------------------------------
        //     *`servers` => SSH server list
        // -------------------------------------
        'servers' => [

            // -------------------------------------
            //     *{example} => SSH server name
            // -------------------------------------
            'example' => [
                ...
                // ------------------------------------------
                //     *`pswd` => SSH server user password
                //     (required when `auth` => pswd)
                // ------------------------------------------
                'pswd' => 'lif',
